...
begin
	...
	yaml_obj = StudentsListYAML.new(file_path)
	
	array_of_students.each { |student| yaml_obj.add_student(student) }
	yaml_obj.write_to_file
	
	puts "\n"
	
	data_list_student_short = yaml_obj.get_k_n_student_short_list(1, 5)
	...
	data_list_student_short = yaml_obj.get_k_n_student_short_list(2, 5, data_list_student_short)
