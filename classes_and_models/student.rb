class Student
	attr_reader :student_id, :surname, :name, :patronymic, :phone_number, :telegram, :email_address, :git
	attr_writer :student_id, :surname, :name, :patronymic, :phone_number, :telegram, :email_address, :git
